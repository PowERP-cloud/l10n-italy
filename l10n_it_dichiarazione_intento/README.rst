...
==================================================
|icon| ITA - Dichiarazione di intento 12.0.0.1.6_1
==================================================


**Gestione dichiarazioni di intento**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/l10n-italy/12.0/l10n_it_dichiarazione_intento/static/description/icon.png
...
|en| This module allows you to manage declarations of intent.


|

|it| Questo modulo consente di gestire le dichiarazioni d'intento.
...
* |menu| Setting > Apps |right_do| Select **l10n_it_dichiarazione_intento** > Install
