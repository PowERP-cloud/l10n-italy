...
class AssetJournalXslx(models.AbstractModel):
    ...
    def set_formats(self, workbook, report_data):
        ...
        report_data['formats']['format_depreciation_header'] = (
            workbook.add_format({
                "align": "center",
                "bold": True,
                "font_size": 12,
        ...
        report_data['formats']['format_depreciation_value'] = (
            workbook.add_format({
                "align": "center",
                "font_size": 12,
            })
    ...
    def set_depreciation_data(self, report_data):
        report_data['depreciation_data'] = self.generate_depreciation_data(
            report_data)
    ...
    def get_max_width_dict(self, report_data):
        ...
        max_col = max(
            [
                ...
                max(report_data[
                        'depreciation_line_accounting_doc_data'].keys()),
            ...
            col: max(
                [
                    ...
                    report_data['depreciation_line_amount_detail_data'].get(
                        col, {}).get("width")
                    or 0,
                    report_data['depreciation_line_accounting_doc_data'].get(
                        col, {}).get("width")
                    or 0,
    ...
    def _write_report_title(self, title, report_data):
        ...
        * Overrides standard method *
        ...
        """
        report_data['sheet'].merge_range(report_data['row_pos'], 0,
                                         report_data['row_pos'] + 1, 9,
                                         title, report_data[
                                             'formats']['format_title']
        )
    ...
    def _generate_report_content(self, workbook, objects, data, report_data):
        ...
        for categ_section in report.report_category_ids:
            self.write_all(report_data, categ_section,
                           'category_data')

            for asset_section in categ_section.report_asset_ids:
                self.write_all(report_data, asset_section,
                               'asset_data')
                ...
                for dep_section in asset_section.report_depreciation_ids:
                    self.write_all(
                        report_data, dep_section, 'depreciation_data')
