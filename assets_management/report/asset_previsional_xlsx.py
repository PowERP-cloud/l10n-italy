...
class AssetJournalXslx(models.AbstractModel):
    ...
    def set_formats(self, workbook, report_data):
        ...
        report_data['formats'][
            'format_depreciation_header'] = workbook.add_format(
            {
                "align": "center",
                "bold": True,
                "font_size": 12,
        ...
        report_data['formats'][
            'format_depreciation_value'] = workbook.add_format(
            {
                "align": "center",
                "font_size": 12,
            }
        ...
        report_data['formats'][
            'format_depreciation_year_line_header'] = workbook.add_format(
            {
                "align": "center",
                "bold": True,
                "font_size": 12,
        ...
        report_data['formats'][
            'format_depreciation_year_line_value_center'] = workbook.add_format(
            {
                "align": "center",
                "font_size": 12,
            }
        ...
        report_data['formats'][
            'format_depreciation_year_line_value_right'] = workbook.add_format(
            {
                "align": "right",
                "font_size": 12,
            }
    ...
    def set_depreciation_data(self, report_data):
        report_data['depreciation_data'] = (
            self.generate_depreciation_data(report_data)
        )
        ...
        return {
            col: max(
                [
                    ...
                    report_data['asset_accounting_doc_data'].get(col, {}).get(
                        "width") or 0,
                    report_data['depreciation_data'].get(col, {}).get(
                        "width") or 0,
                    report_data['depreciation_line_year_data'].get(col, {}).get(
                        "width") or 0,
                    report_data['depreciation_line_amount_detail_data'].get(
                        col, {}).get("width")
                    or 0,
    ...
    def _write_report_title(self, title, report_data):
        ...
        * Overrides standard method *
        ...
        report_data['sheet'].merge_range(
            report_data['row_pos'], 0, report_data['row_pos'] + 1, 9, title,
    ...
    def _define_formats(self, workbook, report_data):
        ...
        report_data["formats"] = {
            ...
            "format_amount_bold": workbook.add_format(
                {"bold": True}).set_num_format(
        ...
        report_data["formats"]["format_percent_bold_italic"].set_num_format(
            "#,##0.00%")
