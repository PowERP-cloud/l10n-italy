...
================================================
|icon| ITA - Liquidazione IVA evoluta 12.0.1.9.1
================================================


**Allow to create the "VAT Statement".**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/l10n_it_vat_statement/static/description/icon.png
